            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="codigo" class="form-control" type="text" name="codigo" placeholder="Codigo producto" onkeyup="buscarCodigoVenta(event);">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        ...
                        <input id="cantidad" class="form-control" type="text" name="cantidad" onkeyup="calcularPrecioVenta(event);" disabled>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
