...
class ComprasModel extends Query{
    ...
    public function registrarDetalle(string $table, int $id_producto, int $id_usuario, string $precio, float $cantidad, string $sub_total)
    {
    ...
    public function actualizarDetalle(string $table, string $precio, float $cantidad, string $sub_total, int $id_producto, int $id_usuario)
    {
    ...
    public function registrarDetalleCompra(int $id_compra,int $id_pro, float $cantidad, string $precio, string $sub_total)
    {
    ...
    public function registrarDetalleVenta(int $id_venta,int $id_pro, float $cantidad, string $precio, string $sub_total)
    {
    ...
    public function actualizarStock(float $cantidad, int $id_pro)
    {
